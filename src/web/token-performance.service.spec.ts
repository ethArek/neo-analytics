...
describe('TokenPerformanceService', () => {
  ...
  it('returns top gainers and losers for the last 24h, 7 days, and 30 days', async () => {
    ...
    const latestRows = [
      ...
      { symbol: 'FLM', unwrappedSymbol: 'FLM', hash: '0xflm', usd_price: 0.00001234 },
    ...
    const last24hRows = [
      ...
      { symbol: 'FLM', unwrappedSymbol: 'FLM', hash: '0xflm', usd_price: 0.00000845 },
      { symbol: 'FUSD', unwrappedSymbol: 'FUSD', hash: '0xfusd', usd_price: 1 },
    ];
    const last7dRows = [
      { symbol: 'NEO', unwrappedSymbol: 'NEO', hash: '0xneo', usd_price: 10 },
      { symbol: 'GAS', unwrappedSymbol: 'GAS', hash: '0xgas', usd_price: 9 },
      { symbol: 'FLM', unwrappedSymbol: 'FLM', hash: '0xflm', usd_price: 0.00000617 },
    ...
    const last30dRows = [
      ...
      { symbol: 'FLM', unwrappedSymbol: 'FLM', hash: '0xflm', usd_price: 0.0000105 },
      { symbol: 'FUSD', unwrappedSymbol: 'FUSD', hash: '0xfusd', usd_price: 1.2 },
    ];
