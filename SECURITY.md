...
Security updates are provided for the latest minor release on the default branch.

## Disclosure process

1. Triage and confirm the vulnerability.
2. Develop a fix and tests.
3. Coordinate a release and disclose the issue once a patch is available.
